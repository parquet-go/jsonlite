...
func hashCorpora() map[string][]string {
	...
	return map[string][]string{
		"cloudLogging": {
			"logName", "insertId", "timestamp", "receiveTimestamp", "severity",
			"textPayload", "resource", "labels", "httpRequest", "trace",
			"spanId", "traceSampled", "operation", "sourceLocation", "split",
			"requestMethod", "requestUrl", "requestSize", "status",
			"responseSize", "userAgent", "remoteIp", "serverIp", "referer",
			"latency", "cacheLookup", "cacheHit", "protocol",
		},
		"snakeCase": {
			"user_id", "user_name", "user_email", "user_created_at",
			"user_updated_at", "account_id", "account_name", "account_type",
			"request_id", "request_method", "request_url", "request_headers",
			"response_code", "response_body", "response_headers", "trace_id",
		},
		"shortKeys": {
			"id", "ts", "op", "k", "v", "a", "b", "x", "y", "z",
			"url", "sql", "err", "msg", "tag", "seq",
		},
